...
function YouMute() {
  ...
  style.innerHTML = `.adInProgress .html5-video-player {
    opacity: 0 !important;
}`;
  this.style = style;
}
...
YouMute.prototype.getRemainingTime = function () {
  var videoAdUiPreSkipText =
    document.getElementsByClassName("ytp-ad-preview-text-modern")[0] ||
    document.getElementsByClassName("ytp-preview-ad__text")[0];
